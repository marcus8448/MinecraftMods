...
public class SnowyFabric implements ModInitializer {
    ...
    public void onInitialize() {
        BiomeModifications.create(new ResourceLocation(Constant.MOD_ID, "freeze_surface")).add(ModificationPhase.ADDITIONS, biome -> canModify(biome) && !biome.hasPlacedFeature(MiscOverworldPlacements.FREEZE_TOP_LAYER), context -> {
        ...
        BiomeModifications.create(new ResourceLocation(Constant.MOD_ID, "change_weather")).add(ModificationPhase.POST_PROCESSING, SnowyFabric::canModify, context -> {
